...
import java.io.IOException; // импорт обработки исключений

public class CatGame {
    static String name;
    static int age = 0; // возвраст кота
    static double weight = 3.0; // вес кота
    static byte hunger = 0; // голод
    static byte needgames = 0; // игры
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        while (program) {
            for (int variants = 0; variants < 500; variants++) {
                ...
                if (variants >= 20) { //Каждый 20-й раз появление этого меню должно сопровождаться прибавлением 1 года к жизни кота.
                    age += 1;
                }
                hunger -= 5;  // Каждый вызов этого меню должен сопровождаться уменьшением его массы на несколько грамм и увеличением голода:
                if (hunger <= 0) {
                    hunger = 0;
                }
                weight -= 0.1;
